...
public class Demo1 {
	...
	//output [Student [roll=12, name=N2, marks=400], Student [roll=13, name=N3, marks=420], Student [roll=14, name=N4, marks=440], Student [roll=16, name=N6, marks=380]]
	
		///single line
		List<Student> filteredList1= students.stream().filter(s->s.getMarks() < 500).collect(Collectors.toList());
		filteredList1.forEach(s->System.out.println(s));
